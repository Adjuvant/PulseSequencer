...
public partial class Contexts : Entitas.IContexts {
    ...
    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { audio, game, input }; } }
...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        audio.AddEntityIndex(new Entitas.EntityIndex<AudioEntity, IntVector2>(
            Position,
            audio.GetGroup(AudioMatcher.Position),
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<AudioEntity> GetEntitiesWithPosition(this AudioContext context, IntVector2 value) {
        return ((Entitas.EntityIndex<AudioEntity, IntVector2>)context.GetEntityIndex(Contexts.Position)).GetEntities(value);
    }
